...
class ConfigResult:
    ...
    @strawberry.field
    def plugins(self, include: list[ID] | None = None) -> dict[str, dict[str, Any]]:  # noqa: ARG002
        """Get plugin configuration.

        Args:
            include: Optional list of plugin IDs to include (not yet implemented)

        Returns:
            Plugin configuration map
        """
        # TODO: Implement plugin filtering using include parameter
        return {}
