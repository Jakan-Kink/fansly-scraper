...
class TestAccountProcessingMixin:
    ...
    @pytest.mark.asyncio
    async def test_find_account(self, mixin, mock_account):
    ...
    @pytest.mark.asyncio
    async def test_process_creator(self, mixin, mock_account, mock_performer):
        """Test process_creator method."""
        # Mock methods
        mixin._find_account = AsyncMock(return_value=mock_account)
        ...
        mixin._find_existing_performer.assert_called_once_with(mock_account)
    ...
    @pytest.mark.asyncio
    async def test_update_performer_avatar(self, mixin, mock_account, mock_performer):
        ...
        await mixin._update_performer_avatar(mock_account, mock_performer)
    ...
    @pytest.mark.asyncio
    async def test_find_existing_performer(self, mixin, mock_account):
        ...
        performer = await mixin._find_existing_performer(mock_account)
    ...
    @pytest.mark.asyncio
    async def test_update_account_stash_id(self, mixin, mock_account, mock_performer):
