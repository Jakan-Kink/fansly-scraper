...
class TestStashProcessingBaseErrorPaths:
    ...
    async def test_scan_creator_folder_metadata_scan_error(
        ...
        async with (
            ...
            with (
                ...
                try:
                    with pytest.raises(
                        RuntimeError, match="Failed to process metadata"
                    ):
                        await real_stash_processor.scan_creator_folder()
                finally:
                    dump_graphql_calls(
                        calls, "test_scan_creator_folder_metadata_scan_error"
                    )
        ...
        async with (
            ...
            with (
                ...
                try:
                    ...
                    dump_graphql_calls(
                        calls, "test_scan_creator_folder_wait_for_job_retry"
                    )
        ...
        async with (
            ...
            with (
                ...
                try:
                    ...
                    dump_graphql_calls(
                        calls, "test_scan_creator_folder_download_path_creation_fails"
                    )
        ...
        async with (
            ...
            with capture_graphql_calls(client) as calls:
                try:
                    ...
                    dump_graphql_calls(
                        calls, "test_cleanup_with_running_background_task"
                    )
    ...
    async def test_cleanup_with_no_background_task(
        ...
        """
        async with (
            stash_cleanup_tracker(real_stash_processor.context.client),
        ):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    dump_graphql_calls(calls, "test_cleanup_with_no_background_task")
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    dump_graphql_calls(calls, "test_cleanup_with_no_cleanup_event")
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                ...
                try:
                    ...
                    dump_graphql_calls(calls, "test_cleanup_event_wait_timeout")
            ...
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                ...
                try:
                    try:
                        ...
                        dump_graphql_calls(
                            calls, "test_cleanup_without_config_attribute"
                        )
            ...
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                ...
                try:
                    try:
                        ...
                        dump_graphql_calls(
                            calls, "test_cleanup_context_close_exception"
                        )
            ...
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                ...
                try:
                    try:
                        ...
                        dump_graphql_calls(
                            calls, "test_safe_background_processing_without_config"
                        )
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    dump_graphql_calls(
                        calls, "test_safe_background_processing_task_removal"
                    )
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    # No GraphQL calls should be made, but we capture just in case
                    dump_graphql_calls(
                        calls,
                        "test_safe_background_processing_without_cleanup_event",
                    )
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    dump_graphql_calls(
                        calls,
                        "test_safe_background_processing_task_already_removed",
                    )
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    dump_graphql_calls(calls, "test_cleanup_with_matching_own_tasks")
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    dump_graphql_calls(calls, "test_cleanup_exception_in_try_block")
    ...
    async def test_preload_stash_entities_with_real_data(
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    cache_before = (
                        real_stash_processor.store.cache_stats().total_entries
                    )
                    ...
                    dump_graphql_calls(
                        calls, "test_preload_stash_entities_with_real_data"
                    )
        ...
        async with stash_cleanup_tracker(real_stash_processor.context.client):
            with capture_graphql_calls(real_stash_processor.context.client) as calls:
                try:
                    ...
                    dump_graphql_calls(calls, "test_cleanup_cache_stats_failure")
